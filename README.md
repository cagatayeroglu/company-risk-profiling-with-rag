...
├── HANDOFF.md                    # Detailed change log / developer handoff notes
...
by the project team. An AI coding assistant was used in a supporting role only — for implementation
help, suggesting alternatives we reviewed, and drafting parts of the report. All AI-assisted code and
text were reviewed, tested, and validated by us. See the final report's "AI Usage" section for details.
